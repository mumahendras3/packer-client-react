                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                            <div className="w-full h-100">
                                <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">Get Started</h1>
                                <h2 className="text-gray-400">Create your account now</h2>

                                <form className="mt-6" action="#" method="POST">
                                    <div>
                                        <label className="block text-gray-700">Name</label>
                                        <input type="name" name="" id="name" placeholder="Enter Your Name" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autoFocus autoComplete="false" required />
                                    </div>
                                ...
                                <p className="mt-8 text-center">Have an account? <Link to={'/login'} className="text-blue-500 hover:text-blue-700 font-semibold">Login</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
